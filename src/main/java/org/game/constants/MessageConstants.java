...
public class MessageConstants {
    ...
    public static final String NUMBER_OF_GAMES_MSG = "Enter number of games to play: ";
    public static final String NEGATIVE_NUMBER_MSG = "Number of games must be greater than 0";
    public static final String INVALID_NUMBER_MSG = "Invalid input. Please enter a valid number.";
    public static final String TEXT_LINE_SEPARATOR = "----------------------------";
    public static final String ROUND_NUMBER_MSG = "ROUND ";
    public static final String FINAL_ROUND_MSG = "FINAL ROUND!";
    ...
    public static final String USER_WIN_MSG = "You win!";
